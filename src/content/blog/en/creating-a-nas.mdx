...
This left me with a nice shared 500GB of storage for my entire family, and the possibility of installing the software I mentioned earlier, specifically, I installed __Jellyfin__ for watching movies and __Immich__ for storing important pictures.
...
The hardest part of this whole build was allowing access to the NAS from outside my home. I care quite a bit about privacy and security, which is why it did not seem to me like a particularly good idea to give the internet unrestricted access to my family's most important files.

If you ask around online, people will tell you that the perfect solution to this problem is a VPN. It allows you to access a machine, in this instance, the NAS, as if it was in the same network as you from anywhere in the world. It would be exactly what I need, except for one problem: I am not the only person using this machine. While I could easily figure out a VPN, could my sister? Could my mom? What about their work laptops where they can't install software? They already had trouble with normal SMB shares, now I wanted them to install and run a completley new program to access it? On all their devices? Forever?
...
This little NAS experiment went from shits-and-giggles to genuinely useful piece of hardware at home, now all of mine and my family's most important documents are backed up in our very own _cloud_.
...
Sometimes I need to SSH into the NAS to manually edit the ACLs, but it works.
